...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/decentralised-dataexchange/bb-consent-ios-privacy-dashboard'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Mumthasir mohammed' => 'mumthasir.mohammed@igrant.io' }
  s.source           = { :git => 'https://github.com/decentralised-dataexchange/bb-consent-ios-privacy-dashboard', :tag => s.version.to_s }
